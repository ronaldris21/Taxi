...
{
    public partial class addEntities_Trip_and_TripDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripDetais", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripDetais_Trips_TripId",
                        column: x => x.TripId,
